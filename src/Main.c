...
Useful data type information:
    Float32:
        ...
        Remarks: Prefer to use floats as most GPUs are optimized for 32 bit floating point arithmetric
    Double64:
...
Useful constants:
    Age of the universe in seconds: ~4.35 * 10^17s
    Gravitational constants: 6.67430e-11
...
//! presentation so we don't have to deal with platfrom specific GUIs
